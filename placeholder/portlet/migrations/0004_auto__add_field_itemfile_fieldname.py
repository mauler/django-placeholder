...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemFile.fieldname'
        db.add_column(u'portlet_itemfile', 'fieldname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemFile.fieldname'
        db.delete_column(u'portlet_itemfile', 'fieldname')
